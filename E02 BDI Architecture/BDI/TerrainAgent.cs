...
namespace Bdi
{
    ...
    public class TerrainAgent : ActressMas.Agent
    {
        private TerrainForm formGui;
        ...
        {
            formGui = new TerrainForm();
            formGui.SetOwner(this);
            formGui.ShowDialog();
            Application.Run();
        }
        ...
        public override void Act(ActressMas.Message message)
        {
            try
            {
                ...
                {
                    case "move":
                        if (turns == 4) States[4] = TerrainState.Fire; // at some point, start a fire
                        if (turns == 20) States[7] = TerrainState.Fire;
                        if (turns == 50) States[9] = TerrainState.Fire;
