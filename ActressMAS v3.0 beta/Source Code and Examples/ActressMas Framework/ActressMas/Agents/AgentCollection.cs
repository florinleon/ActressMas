...
namespace ActressMas
{
    internal class AgentCollection
    {
        ...
        public int Count
        {
            get
            {
                return _parallel ? AgentsC.Count : AgentsS.Count;
            }
        }

        public bool ContainsKey(string name)
        {
            return _parallel ? AgentsC.ContainsKey(name) : AgentsS.ContainsKey(name);
        }
        ...
        public ICollection<string> Keys
        {
            get
            {
                return _parallel ? AgentsC.Keys : AgentsS.Keys;
            }
        }
        ...
        public ICollection<Agent> Values
        {
            get
            {
                return _parallel ? AgentsC.Values : AgentsS.Values;
            }
        }

        public KeyValuePair<string, Agent> ElementAt(int index)
        {
            return _parallel ? AgentsC.ElementAt(index) : AgentsS.ElementAt(index);
        }
