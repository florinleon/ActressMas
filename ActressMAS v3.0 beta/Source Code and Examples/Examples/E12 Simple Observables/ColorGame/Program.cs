...
namespace ColorGame
{
    ...
    public class MyAgent : Agent
    {
        ...
        {
            Console.WriteLine($"I am {this.Name}. I am looking around...");
        ...
        public override void ActDefault()
        {
            ...
            this.Observables["Color"] = Colors.ChangeColor();

            Console.WriteLine($"\r\nMy color is now {this.Observables["Color"]}");
            Console.WriteLine("-------------------------------------------");
        }
    }
