...
namespace NumberGame
{
    ...
    public class MyAgent : Agent
    {
        ...
        {
            this.Observables["Number"] = $"{Numbers.ChangeNumber():F2}";
        }

        public override bool PerceptionFilter(Dictionary<string, string> observed)
        {
            double myNumber = Convert.ToDouble(this.Observables["Number"]);
        ...
        public override void ActDefault()
        {
            ...
            {
                Console.WriteLine($"My number is {this.Observables["Number"]} and I saw:");
            ...
            Console.WriteLine($"My number is now {this.Observables["Number"]}");
            Console.WriteLine("----------------------------------------------");
        }
    }
    ...
    public class Numbers
    {
        ...
        public static double ChangeNumber()
        {
