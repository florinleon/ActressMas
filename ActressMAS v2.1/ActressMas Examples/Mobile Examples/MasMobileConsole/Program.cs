...
namespace MasMobileConsole
{
    public static class Program
    {
        ...
        public static void Main()
        {
            ...
            Container container = new Container(_serverIP, Convert.ToInt32(_serverPort), _containerName);
            ...
            container.RunConcurrentMas(new ConcurrentEnvironment(), new MasMobileConsole.MasSetup());
        }
